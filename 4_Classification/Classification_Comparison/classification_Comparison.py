...
for key in classifiers:
    ...
    adict[key]=[accuracy, round(Precision,3), round(Sensitivity,3), round(Specificity,3) ,round(error,4), round(False_Positive_Rate,3)]

print(pd.DataFrame.from_dict(adict, orient='index', columns=['Accuracy', 'Precision', 'Sensitivity', 'Specificity','Error', 'False_Positive_Rate']))